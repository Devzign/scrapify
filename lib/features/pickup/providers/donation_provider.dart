...
class DonationNotifier extends Notifier<DonationState> {
  static final List<Category> donationCategories = [
    ...
    Category(
      id: 23,
      name: LocalizedName(en: 'Newspapers', hi: 'समाचार पत्र'),
      slug: 'newspapers',
      imageUrl: '',
      attributes: const [],
      children: const [],
    ...
    Category(
      id: 24,
      name: LocalizedName(en: 'Electronics', hi: 'इलेक्ट्रॉनिक्स'),
      slug: 'electronics',
      imageUrl: '',
      attributes: const [],
      children: const [],
    ...
    Category(
      id: 25,
      name: LocalizedName(en: 'Plastic Waste', hi: 'प्लास्टिक कचरा'),
      slug: 'plastic',
      imageUrl: '',
      attributes: const [],
      children: const [],
