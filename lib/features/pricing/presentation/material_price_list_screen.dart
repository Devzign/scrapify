...
class _MaterialPriceListScreenState
  ...
  IconData _iconFor(String name) {
    ...
    if (l.contains('copper')) return FontAwesomeIcons.boltLightning;
    if (l.contains('iron') || l.contains('steel'))
      return FontAwesomeIcons.screwdriverWrench;
    if (l.contains('brass')) return FontAwesomeIcons.hammer;
    ...
    if (l.contains('plastic')) return FontAwesomeIcons.recycle;
  ...
  Color _iconColorFor(String name) {
    final l = name.toLowerCase();
    if (l.contains('copper')) return Colors.orange;
    if (l.contains('iron') || l.contains('steel')) return Colors.grey.shade700;
    if (l.contains('brass')) return Colors.yellow.shade700;
    if (l.contains('paper') || l.contains('newspaper'))
      return Colors.grey.shade800;
    if (l.contains('phone') || l.contains('mobile')) return Colors.blue;
    if (l.contains('ac') || l.contains('air')) return Colors.cyan;
    if (l.contains('plastic')) return Colors.green;
    return Colors.teal;
  }

  Color _iconBgFor(String name) =>
      _iconColorFor(name).withValues(alpha: 0.1);
  ...
  Widget build(BuildContext context) {
    ...
    final categoryNames = [
      'All',
      ...cats.map((c) => c['name']?.toString() ?? '').where((n) => n.isNotEmpty),
    ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Material Price List',
            style: TextStyle(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Text('TODAY\'S RATES / आज के भाव',
                    style: TextStyle(
  ...
  Widget _buildFallbackList() {
    final items = [
      ('Copper Wire', 'तांबे की तार', '₹450', '/ kg',
          FontAwesomeIcons.boltLightning, Colors.orange, Colors.orange.shade50),
      ('Iron Heavy', 'लोहा भारी', '₹32', '/ kg',
          FontAwesomeIcons.screwdriverWrench, Colors.grey.shade700, Colors.grey.shade100),
      ('Brass Mix', 'पीतल मिक्स', '₹305', '/ kg',
          FontAwesomeIcons.hammer, Colors.yellow.shade700, Colors.yellow.shade100),
      ('Newspaper', 'पुराना अखबार', '₹14', '/ kg',
          FontAwesomeIcons.newspaper, Colors.grey.shade800, Colors.grey.shade200),
      ('Smartphone', 'स्मार्टफोन', '₹20', '/ pc',
          FontAwesomeIcons.mobileScreen, Colors.blue, Colors.blue.shade50),
      ('Split AC (1.5T)', 'एसी (पुराना)', '₹3500', '/ pc',
          FontAwesomeIcons.snowflake, Colors.cyan, Colors.cyan.shade50),
    ];
